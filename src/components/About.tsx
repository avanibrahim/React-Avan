  ...
  const education = [
    {
      ...
      level: '',
      logo: '/_optimized/image/logounisangorut.webp',
      period: '2020 - 2024'
    },
    {
      id: 2,
      ...
      level: '',
      logo: '/_optimized/image/sma.webp',
      period: '2017 - 2020'
    },
    {
      id: 3,
      ...
      level: '',
      logo: '/_optimized/image/smp.webp',
      period: '2014 - 2017'
    }
  ];
          ...
          <div className="space-y-6">
            ...
            >
              ...
              {education.map((edu, index) => (
                <div 
                  key={edu.id} 
                  className="glass-card p-3 sm:p-4 mb-4 cursor-pointer transform transition-all duration-300 hover:shadow-lg"
                  style={{
                    opacity: isVisible ? 1 : 0,
            ...
            >
              ...
              <div className="glass-card p-4 sm:p-6 cursor-pointer transform transition-all duration-500 hover:shadow-xl">
